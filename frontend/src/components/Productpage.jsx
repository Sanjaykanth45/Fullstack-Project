...
const Product = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            formData.append("price", product.price); // Add price to form data
            if (product.image) {
            ...
            setIsEditing(false);
            setEditId(null);
            setProduct({ brandname: "", productname: "", description: "", price: "", image: null });
        } catch (error) {
    ...
    const handleEdit = (selectedProduct) => {
        ...
        setProduct({
            ...
            price: selectedProduct.price, // Set price when editing
                ...
                <div className="modal-overlay">
                    <div className="modal-content">
                        ...
                        <form className="brand-form-grid" onSubmit={handleSubmit}>
                            ...
                            <div className="form-group">
                                <label>Price</label>
                                <input type="number" placeholder="Enter Price" value={product.price} name="price" onChange={handleChange} required />
                            </div>
